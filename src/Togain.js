...
const Togain=()=>{
    return(
      ...
      <ol> 
      <li className="h4 mt-3 ">Breakfast:</li>
...
<li className="h4 mt-3 ">Mid morning snack:</li>
1 orange or apple or 1 cup of green tea + 2 to 3 multigrain biscuits
<li className="h4 mt-3 ">Lunch:</li>
...
<li className="h4 mt-3 ">Evening:</li>
...
<li className="h4 mt-3 ">Dinner:</li>
...
<li className="h4 mt-3 ">Bed time:</li>
